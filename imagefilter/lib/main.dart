    ...
    return ValueListenableBuilder(
      ...
      builder: (context, value, child) {
        ...
        return Image.network(
          'https://i.pinimg.com/236x/f7/33/45/f73345befc567fc367576ddc4660ef8b.jpg',
...
class _FilterSelectorState extends State<FilterSelector> {
  ...
  _save() async {
    ...
    if (status.isGranted) {
      var response = await Dio().get("https://i.pinimg.com/236x/f7/33/45/f73345befc567fc367576ddc4660ef8b.jpg", options: Options(responseType: ResponseType.bytes));
